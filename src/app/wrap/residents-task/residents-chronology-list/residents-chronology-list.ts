...
@Component({
  selector: 'app-residents-chronology-list',
  templateUrl: './residents-chronology-list.html',
  styleUrls: ['./residents-chronology-list.scss'],
  imports: [
    ReactiveFormsModule,
    IonHeader,
    IonToolbar,
...
export class ResidentsChronologyList implements OnInit {
  ...
  navigateToChronology(event: Event, resident: ResidentOut) {
    event.preventDefault();
    event.stopPropagation();

    this.navCtrl.navigateForward(`/wrap/residents-tasks/chronology`, {
      animated: true,
      state: { resident }
    });
  }
