...
export function listResidencesResidencesGet(http: HttpClient, rootUrl: string, params?: ListResidencesResidencesGet$Params, context?: HttpContext): Observable<StrictHttpResponse<PaginatedResponse>> {
