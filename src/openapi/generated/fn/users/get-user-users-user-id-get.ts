...
export function getUserUsersUserIdGet(http: HttpClient, rootUrl: string, params: GetUserUsersUserIdGet$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: any;
}>> {
